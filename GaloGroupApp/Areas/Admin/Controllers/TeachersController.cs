...
namespace GaloGroupApp.Areas.Admin.Controllers
{
    public class TeachersController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,TeacherFullName,NationalNo,PhoneNumber,MobileNumber,Address,Biography")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,TeacherFullName,NationalNo,PhoneNumber,MobileNumber,Address,Biography")] Teacher teacher)
        {
            if (ModelState.IsValid)
            {
